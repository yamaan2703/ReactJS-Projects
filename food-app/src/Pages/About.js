      ...
      <div className='container pt-40'>
        <div className='row'>
          <div className='col-md-6'>
            <div className='about_text text-white text-center border p-3 w-full md:w-full lg:w-[500px] mx-0 md:mx-0 lg:mx-5'>
          ...
          <div className='col-md-6'>
            <div className='about_img border px-0 md:px-0 lg:px-4'>
