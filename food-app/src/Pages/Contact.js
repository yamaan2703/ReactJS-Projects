...
function Contact() {
  return (
    <div className="contact_section bg-[#0f1d22]">
      <div className="container pt-40 md:pt-40 lg:pt-40">
        <div className="row">
          <div className="col-md-8">
            <div className="contact_form text-center">
              ...
              <div className="text-center py-3">
                <Button label="Book A Table" /> {/* Assuming Button component accepts a label prop */}
              </div>
            </div>
          </div>
          ...
          <div className="col-md-4">
            <div className="contact_img text-white text-center">
              <div className="">
                <h1 className="text-3xl md:text-3xl lg:text-5xl font-serif pb-1">
                  Contact Us
                </h1>
                <p className="text-[#e4c590] font-bold text-lg py-1">
                  Booking Request
                </p>
